...
| Term                   |  Adj Odds Ratio|  Adj Conf: Lower bound|  Adj Conf: Upper bound|
|:-----------------------|---------------:|----------------------:|----------------------:|
| (Intercept)            |           2.850|                  1.835|                  4.465|
| victim\_age            |           0.996|                  0.990|                  1.002|
| victim\_sex: male      |           0.413|                  0.316|                  0.539|
| victim\_race: nonwhite |           0.453|                  0.321|                  0.636|
...
```
    ...
    ##    <chr>                <dbl>    <dbl>     <dbl>
    ##  1 Albuquerque, NM       1.99     1.52      3.08
    ##  2 Atlanta, GA           2.15     1.54      3.75
    ##  3 Baltimore, MD         1.57     1.38      1.89
    ##  4 Baton Rouge, LA       1.93     1.35      3.97
    ##  5 Birmingham, AL        2.85     1.86      5.81
    ##  6 Boston, MA            1.13     1.05      1.31
    ##  7 Buffalo, NY           1.56     1.27      2.25
    ##  8 Charlotte, NC         1.74     1.37      2.54
    ##  9 Chicago, IL           1.78     1.56      2.12
    ## 10 Cincinnati, OH        1.39     1.20      1.74
    ## # ... with 37 more rows
...
![](p8105_hw6_alc2279_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
![](p8105_hw6_alc2279_files/figure-markdown_github/unnamed-chunk-10-1.png)
...
![](p8105_hw6_alc2279_files/figure-markdown_github/unnamed-chunk-13-1.png)
